...
function TestimonyCard({ testimony, isOwn }: { testimony: Testimony; isOwn: boolean }) {
  ...
  return (
    <div className="rounded-xl bg-card p-6" style={{ boxShadow: "0 1px 6px rgba(146,64,14,0.08)" }}>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        {/* Post form */}
        {showForm && userId && (
          <div className="mb-8 rounded-xl bg-card p-6" style={{ boxShadow: "0 1px 6px rgba(146,64,14,0.08)" }}>

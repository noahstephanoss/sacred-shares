...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Testimonies" },
      { property: "og:url", content: "https://testimonies.chat/" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Testimonies — A Faith-Based Community" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "Testimonies",
          url: "https://testimonies.chat/",
          description: "Share your testimony, seek righteous counsel, and grow in faith with a community rooted in truth.",
        }),
      },
      {
        type: "application/ld+json",
